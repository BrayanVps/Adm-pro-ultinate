...
wget -O trans https://raw.github.com/BrayanVps/Adm-pro-ultinate/master/trans -o /dev/null 2>&1
...
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -ne "${cor[4]}"
wget -O lista https://raw.github.com/BrayanVps/Adm-pro-ultinate/master/Lista -o /dev/null
valid_fun
